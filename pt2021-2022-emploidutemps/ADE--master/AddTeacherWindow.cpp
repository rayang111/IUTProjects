...
/*
* Classe permetant de créer un intervenant (admin)
**/

/*
* Constructeur de la classe permetant de créer un intervenant
**/
...
/*
* Méthode permetant d'ajouter l'intervenant à la base de données
**/
...
/*
* Méthode SLOT permetant de gérer ce qui se passe lorsque la rêquete d'ajout s'est terminée
**/
...
/*
* Méthode permetant de quitter le formulaire d'ajout d'intervenant
**/
